...
namespace BookBorrowing.Web.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<Library> _signInManager;
        private readonly UserManager<Library> _userManager;
        private readonly IUserStore<Library> _userStore;
        ...
        private Library CreateUser()
        {
            try
            {
                return Activator.CreateInstance<Library>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Library)}'. " +
                    $"Ensure that '{nameof(Library)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<Library> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<Library>)_userStore;
        }
    }
}
